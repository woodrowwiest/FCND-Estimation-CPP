...
VehicleCommand QuadControl::GenerateMotorCommands(float collThrustCmd, V3F momentCmd)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
    ...
    float l = L / sqrtf(2.f);            // Mathematically:
    float c_bar = collThrustCmd;         // t4 Revisit this, see jupiter notebook
    float p_bar = momentCmd.x / l;       // t1
    float q_bar = momentCmd.y / l;       // t2
    float r_bar = - momentCmd.z / kappa; // t3 missing -?
